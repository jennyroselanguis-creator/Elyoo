...
if (isset($_POST['update_cart'])) {
    ...
    foreach ($_POST['quantities'] as $product_id => $quantity) {
        ...
        if ($quantity <= 0) {
            ...
            $errors[] = "Quantity for product ID $product_id set to max available ($max_stock).";
        } else {
...
if (isset($_POST['checkout'])) {
    ...
    if (!empty($customer_phone) && !preg_match('/^[0-9\-\+\s]{7,20}$/', $customer_phone)) {
        $errors[] = "Phone number must be valid (digits, spaces, +, -).";
    }
    if (empty($customer_address) || strlen($customer_address) < 5) {
    ...
    if (!empty($errors)) {
        ...
        $stmt->close();
        // Store buyer email in session for order lookup
    ...
    <header>
        <div class="header-container">
            ...
            <nav>
                ...
                <a href="my_orders.php" class="nav-link">Order</a>
                ...
                <div class="cart-summary" style="background: white; padding: 28px; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); height: fit-content; position: sticky; top: 100px;">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="customer_email" required pattern="^[^@\s]+@[^@\s]+\.[^@\s]+$" title="Enter a valid email address." style="width: 100%; padding: 10px 12px; border: 2px solid #e2e8f0; border-radius: 8px; font-size: 14px; transition: all 0.3s ease;" onfocus="this.style.borderColor='#2563eb'; this.style.boxShadow='0 0 0 4px rgba(37, 99, 235, 0.1)';" onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none';">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="customer_phone" pattern="[0-9\-\+\s]{7,20}" title="Phone number must be 7-20 digits, spaces, + or - allowed." style="width: 100%; padding: 10px 12px; border: 2px solid #e2e8f0; border-radius: 8px; font-size: 14px; transition: all 0.3s ease;" onfocus="this.style.borderColor='#2563eb'; this.style.boxShadow='0 0 0 4px rgba(37, 99, 235, 0.1)';" onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none';">
                        </div>
