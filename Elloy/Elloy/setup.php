                    ...
                    <ol style="margin-left: 20px; line-height: 1.8; color: #333;">
                        ...
                        <li><strong>Add New Product:</strong> 
                            <ul style="margin: 8px 0 8px 20px; font-family: monospace; font-size: 13px;">
                                ...
                                <li>Price: Enter in dollars (e.g., 9999.99)</li>
                ...
                <div style="background-color: #fef2f2; padding: 20px; border-radius: 12px; margin-bottom: 25px; border-left: 4px solid #ef4444;">
                        ...
                        <li><strong>Fill in the fields:</strong>
                            <table style="width: 100%; margin: 10px 0; border-collapse: collapse; font-size: 12px;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 8px; border: 1px solid #fbcfe8;">11999.99</td>
                                </tr>
                                <tr style="background: #fff5f5;">
                    ...
                    <div style="background: #fff; padding: 12px; border-radius: 8px; margin-top: 15px; border: 1px solid #fecaca;">
                        ...
                        <ul style="margin: 8px 0 0 20px; color: #7f1d1d;">
                            ...
                            <li>Use decimal for prices: 9999.99</li>
...
(1, 'iPhone 16 Pro', 'A18 Pro', 'Latest Apple flagship', 12999.99, 20),
(1, 'iPhone 16', 'A18', 'Standard iPhone 16', 10999.99, 25),
(2, 'Samsung Galaxy S25', 'Snapdragon 8 Gen 4', 'Next gen Samsung flagship', 14999.99, 18),
(3, 'Xiaomi 15', 'Snapdragon 8 Gen 3 Leading', 'Premium Xiaomi phone', 9999.99, 22),
(4, 'OnePlus 13', 'Snapdragon 8 Gen 3', 'Fast flagship killer', 11999.99, 16),
(5, 'Realme 13 Pro', 'Snapdragon 7s Gen 2', 'Affordable flagship', 7499.99, 20),
(6, 'OPPO Find X8', 'Snapdragon 8 Gen 3', 'Photography phone', 13999.99, 15);</textarea>
