...
if ($selected_brand > 0) {
    $products_sql = "SELECT p.*, b.name as brand_name FROM products p 
                     JOIN brands b ON p.brand_id = b.id 
                     WHERE p.brand_id = $selected_brand 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['product_id'], $_POST['quantity'])) {
    ...
    if ($new_total > $max_stock) {
        $_SESSION['message'] = "Cannot add more than available stock ($max_stock) for $productName!";
        $_SESSION['notifyType'] = 'error';
    } else {
        $_SESSION['cart'][$product_id] = $new_total;
...
<body>
                        ...
                        <?php if ($product['stock'] > 0): ?>
                            <form method="POST" class="add-to-cart-form">
                                ...
                                <div class="quantity-selector">
                                    ...
                                    <input type="number" name="quantity" value="1" min="1" max="<?php echo $product['stock']; ?>" class="qty-input" style="color: #ffffff !important; -webkit-text-fill-color: #ffffff !important; caret-color: #ffffff; opacity: 1;">
    ...
    <zapier-interfaces-chatbot-embed is-popup="true" chatbot-id="cmncxtwyo005314nezcxl65bs"></zapier-interfaces-chatbot-embed>
